...
This document describes the security architecture of the FlowCentral MCP Server.
...
External access is provided through an **outbound connection** to the FlowCentral cloud server:

1. The local server initiates a Socket.IO connection to `ws.flowcentral.ai`
