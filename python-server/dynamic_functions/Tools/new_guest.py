...
async def new_guest():
    ...
    Returns the front-desk procedure Atlas must follow. Do NOT ask for the guest's
    ...
    return (
        ...
        "1. Greet the guest warmly and introduce yourself — you're Atlas, the front desk assistant.\n"
        "2. Offer them a warm drink (cocoa, coffee, tea) and ask if it's their first time using FlowCentral.\n"
...
async def verify_paperwork(username: str):
    ...
    return (
        ...
        f"If the username is funny or weird, feel free to have a laugh about it — have fun!\n"
