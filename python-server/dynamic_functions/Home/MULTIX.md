# FlowCentral MCP tools

## Overview

You should have an MCP called Atlantis, with the following ways to access the FlowCentral system, which helps us manage enterprise flow automation:
...
You will start at the root of the FlowCentral virtual filesystem arranged by usernames, and then you go into a user's home folder, and then connected MCP server for that user. You cannot go into disconnected servers.
